...
export default function SignUpPage() {
  return (
    <div className="min-h-screen w-full bg-[#09090b] flex items-center justify-center relative overflow-hidden px-4 py-8">
      ...
      <div className="w-full max-w-md z-10 flex flex-col items-center">
        ...
        <div className="mb-6 flex flex-col items-center">
          ...
          <p className="text-xs text-gray-400 mt-1">Create an account to start optimizing</p>
        </div>
